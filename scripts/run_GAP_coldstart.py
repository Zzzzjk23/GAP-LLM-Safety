...
dataset = JailbreakDataset(local_file_type='json', dataset='../easyjailbreak/datasets/data/cold_start_generated_seeds_target_response_all_shuffled_ordered.json')
...
dataset_name = 'GAP_Atk_Vic_Evl_GPT4_Tgt_GPT35_D_ColdStart'
